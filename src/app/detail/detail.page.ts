...
export class DetailPage implements OnInit {
  ...
  getPlat() {
    this.http
      .get(`${this.url}/select/plat/${this.id_recette}`)
  ...
  async getAllProduit() {
    ...
    this.http
      .get(`${this.url}/select/detail/${this.id_recette}`)
      .subscribe((resultData: any) => {
  ...
  addProduit(bodyData: {}) {
    this.http
      .post(`${this.url}/plat/add/produit`, bodyData)
      .subscribe((resultData: any) => {
  ...
  async presentAlert(id: number) {
    ...
    if (role == 'Suprimer') {
      this.http
        .delete(`${this.url}/delete/detail/` + id)
        .subscribe((resultData: any) => {
